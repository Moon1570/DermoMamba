"""
Memory-efficient training script for TinyDermoMamba
...
def main():
    print("="*60)
    print("Memory-Efficient TinyDermoMamba Training")
    print("="*60)
    ...
    # Create datasets with smaller image size for memory efficiency
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            if (batch_idx + 1) % 100 == 0:
                ...
                print(f"  Batch {batch_idx+1}/{len(train_loader)}, "
                      f"Loss: {loss.item():.4f}, "
                      f"Dice: {dice.item():.4f}, "
                      f"Speed: {batches_per_sec:.2f} b/s, "
        ...
        if val_dice > best_dice:
            ...
            torch.save(checkpoint, 'checkpoints/tiny/best_model.pth')
